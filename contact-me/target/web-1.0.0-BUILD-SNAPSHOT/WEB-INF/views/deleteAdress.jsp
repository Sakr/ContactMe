...
<c:url value="/resetDeleteAdress"  var="resetURL" />
<c:url value="/saveDeleteAdress" var="deleteAdressURL" />
<div style="margin:10px;">
	...
	<form:form method="POST"  class="cssform_colonnes_new_width" action="${deleteAdressURL}" target="_parent">
